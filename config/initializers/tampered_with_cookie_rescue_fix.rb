# # Thanks to:
# # http://blog.insoshi.com/2008/08/15/a-security-issue-with-rails-secret-session-keys/
...
class CGI::Session::CookieStore  
  ...
  def restore  
    ...
    RAILS_DEFAULT_LOGGER.warn "Caught TamperedWithCookie exception on #{Time.now}"  
    @data = {}  
  end  
end
